...
export default function ExplorePage() {
  ...
  // Fetch ALL places to build country list, and filtered places for display
  ...
  // Build sorted unique country list from ALL places
    ...
    <section className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <section className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 dark:from-neutral-900 dark:via-primary-950 dark:to-neutral-900 py-14 relative overflow-hidden">
        ...
        <section>
          ...
          <p className="text-primary-200 mb-8 text-lg">Discover amazing places from around the world</p>
          ...
          <section className="flex gap-3 max-w-2xl">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3.5 rounded-xl font-semibold text-sm transition-all shadow-lg ${
                showFilters
      ...
      <section className="page-container py-10">
        <section className="flex items-center justify-between mb-6">
          ...
          {hasFilters && (
            <button onClick={clearFilters} className="text-sm text-primary-600 dark:text-primary-400 font-medium hover:underline">
              Clear all filters
            </button>
          )}
        </section>
        ...
        {loading ? (
          ...
          <section className="text-center py-24">
            ...
            <h3 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 mb-2">No destinations found</h3>
